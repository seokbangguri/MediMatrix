...
const SpermModal = () => {
  ...
  return (
    <div className={sectionClasses}>
      <div className="flex-col bg-white h-5/6 w-[800px] rounded-sm overflow-y-scroll mx-auto flex items-center">
          ...
          <div className="mt-2">
            ...
            <div className="flex flex-row p-3 justify-between">
              <div className="flex flex-col items-center">
                <span>A클래스</span>
                <img className="w-40" src={aclass} alt="sperm-examle" />
              </div>
              <div className="flex flex-col items-center">
                <span>B클래스</span>
                <img className="w-40" src={bclass} alt="sperm-examle" />
              </div>
              <div className="flex flex-col items-center">
                <span>C클래스</span>
                <img className="w-40" src={cclass} alt="sperm-examle" />
              </div>
              <div className="flex flex-col items-center">
                <span>D클래스</span>
                <img className="w-40" src={dclass} alt="sperm-examle" />
              </div>
            </div>
          </div>
          <hr />
