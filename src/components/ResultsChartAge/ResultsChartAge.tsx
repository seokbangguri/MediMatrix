  ...
  return (
    <div className='w-[600px] h-[300px] bg-white p-4 rounded-md'>
      ...
      <ul className='text-sm max-w-[480px] list-disc w-full ml-10 list-inside space-y-2'>
        <li className=''>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolore at expedita nam consequatur voluptatum quaerat blanditiis incidunt fugit dolor?</li>
        <li className=''>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolore at expedita nam consequatur voluptatum</li>
